...
#include "RecordOutputSafety.h"  // --record: refuse to remove_all a non-output dir (B-REC-001)
...
{
    // "-iso-", not "-capture-": --test-host now takes this path too (D-WV-03),
...
struct HostWindowImpl
{
    ...
    // checked before either callback touches `this` (2026-07 audit, A-OWN-005).
    ...
    void ServicePendingAutosave(bool force)
    {
        ...
        Log("[autosave] %s tier=%s in %.1f ms%s\n",
            ...
            force ? " (busy-override)" : "");
        // Tell the UI (2026-07 audit, P2-06). `wrote` previously fed nothing but
...
void HostWindowImpl::OnWebMessage(const std::wstring& json)
{
    ...
    if (msgKind == L"app/ready")
    {
        ...
        // Same replay for autosave health (2026-07 audit, P2-06), and for the
...
HRESULT HostWindowImpl::InitWebView2()
{
    ...
    // D-WV-03) — and the comment on ComputeUserDataFolder already explains why
    ...
    auto environmentHandler =
        MakeEnvironmentStartupCallback(
            ...
            [this, startupToken](HRESULT envHr, ICoreWebView2Environment* env) -> HRESULT
            {
                ...
                // continuation can log or dereference `this` (A-OWN-005).
                if (FAILED(envHr) || !env)
                {
                    ...
                    // (2026-07 audit, D-WV-01). Terminal failure instead, the
                ...
                if (ShouldFailCompositionControllerDispatch(controllerCreateHr))
                {
                    ...
                    // D-WV-01 one call deeper: a live window, no UI, exit 0.
...
HRESULT HostWindowImpl::FinishWebView2ControllerSetup(ICoreWebView2Controller* controller)
{
    ...
    webView->add_WebMessageReceived(
        Callback<ICoreWebView2WebMessageReceivedEventHandler>(
                   ...
                   ICoreWebView2WebMessageReceivedEventArgs* args) -> HRESULT
            {
                ...
                // (2026-07 audit, D-WV-05). No confirmed origin, no dispatch.
                LPWSTR src = nullptr;
                ...
                // Size cap on both ingress paths (2026-07 audit, P2-02).
    ...
    webView->add_NavigationStarting(
        Callback<ICoreWebView2NavigationStartingEventHandler>(
                   ...
                   ICoreWebView2NavigationStartingEventArgs* args) -> HRESULT
            {
                ...
                // to proceed (2026-07 audit, D-WV-05). An unidentifiable target
    ...
    if (!useDevUi)
    {
        ...
        // mapping got (2026-07 audit, D-WV-04).
        if (FAILED(wrrHr))
        {
...
LRESULT HostWindowImpl::MainWndProc(HWND hwnd, UINT msg, WPARAM wp, LPARAM lp)
{
    ...
    case WM_DESTROY:
        ...
        // creation callbacks hold reads dead from here on (A-OWN-005).
        ...
        else if (engine && m_recordMode)
        {
            ...
            else
            {
                ...
                if (tickStatus == host::ClipRunner::Status::Done)
                {
                    ...
                    if (recordExitCode == 0)
                    {
                        // B-REC-001: `out` is validated as relative + traversal-free,
