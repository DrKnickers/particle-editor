...
// the decision the 2026-07 audit filed as G-5. #687 made these skips VISIBLE,
...
function main() {
  ...
  // the end so a green run states plainly what it did NOT exercise (audit G-5).
  const skippedCases = [];
  for (const name of tests) {
    ...
    // indistinguishable from a passing one (2026-07 audit, G-5). A self-skipped
