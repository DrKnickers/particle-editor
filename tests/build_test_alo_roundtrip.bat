...
REM x64 console exe. Links the exact data-model TU set ParticleSystem.cpp +
REM ParticleSystemSerialization.cpp need (same as test_emitter_reorder):
REM ParticleSystem + ParticleSystemSerialization + ChunkReader + ChunkWriter +
