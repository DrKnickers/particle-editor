...
// (2026-07 audit an-audit-finding). `deleteCalls()` returns one entry per delete request,
...
describe("performDelete", () => {
  ...
  // 2026-07 audit an-audit-finding. Three roots used to mean three emitters/delete
  ...
  it("issues exactly ONE batched request for a multi-root delete (an-audit-finding)", () => {
