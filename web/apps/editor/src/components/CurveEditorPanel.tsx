...
export function CurveEditorPanel({ bridge }: Props) {
  ...
  // (2026-07 audit C-005). Refs, not state: a completion handler closes over
  ...
  // ── Mutation-completion scope guard (2026-07 audit C-005) ────────
  //
  ...
  // removed one key of a multi-key paste (2026-07 audit C-006).
