...
// broken readback produces (2026-07 audit, G-7). Counting distinct luminance
...
// readback produces (2026-07 audit, G-7).
//
...
// the assertion below required a JPEG magic number (audit G-7); renamed to match
...
test("first viewport/capture-snapshot after boot returns a valid, non-blank JPEG (cache-flag-off path)", async () => {
  ...
  // right size satisfies every assertion above (audit G-7); a real viewport
