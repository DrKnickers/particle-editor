...
- Tutorial 5's explosion clips now sit the effect dead-centre in the frame instead of small and off in the corner of the editor — a still, centred shot with no camera movement. (The interaction clips still zoom step by step — onto the emitter tree for the drag, the curve editor for the Index staircase, the Atlas Frame Picker as it highlights Frame 0 and Frame 15 — since that zoom is what keeps those UI details legible, not a flourish)
